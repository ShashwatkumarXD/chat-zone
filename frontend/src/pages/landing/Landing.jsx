    ...
    <div>
      ...
      <div className="bg-white h-[100vh]">
        ...
        <div className="hidden md:flex">
          <p className='flex justify-center items-center text-[40px] sm:text-[60px] md:text-[80px] lg:text-[120px] font-bold text-transparent bg-clip-text bg-gray-900 drop-shadow-md tracking-wide mt-[200px] pl-20 pr-20'>
            Welcome to ChatZone!
          </p>
          <ParticleBg />
        </div>
        ...
        <div className='flex flex-col justify-center items-center block md:hidden'>
          ...
          <p className='text-[80px] sm:text-[50px] md:text-[70px] lg:text-[100px] xl:text-[120px] font-bold text-transparent bg-clip-text bg-gray-900 drop-shadow-md tracking-wide mt-[100px] sm:mt-[150px] md:mt-[200px] px-4 sm:px-10 md:px-20 mt-[-30px]'>
            to
          </p>
          <p className='text-[80px] sm:text-[50px] md:text-[70px] lg:text-[100px] xl:text-[120px] font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600 drop-shadow-md tracking-wide mt-[100px] sm:mt-[150px] md:mt-[200px] px-4 sm:px-10 md:px-20 mt-[-30px]'>
            ChatZone
          </p>
          <ParticleBg />
        </div>
